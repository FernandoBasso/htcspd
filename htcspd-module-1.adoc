...
- Interpretation: explains how to interpret data of this type as information thereby establishing the information/data correspondece.
- Template: template function for handling that kind/structure of data.
- Singnature: tells the function consumes TLColor, and that means I cannot pass the function a 3 or 50 or 200, because a TLColor is either 1, or 2, or 3. And it just produces a TLColor.
