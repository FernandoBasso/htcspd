...
; PROBLEM
;
; Design a function that consumes String and Element and looks for a
; data element with the given name. If it finds that element it produces
; the data, otherwise it produces false.
